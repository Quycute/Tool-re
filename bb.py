    ...
    while True:
        ...
        if setup_type == "1":
            ...
            if not accounts:
                ...
                continue
            force_rejoin_interval = int(input(Fore.MAGENTA + "Nhập thời gian bắt buộc khởi động lại Roblox game (vui lòng để trên 9999): " + Style.RESET_ALL)) * 60
